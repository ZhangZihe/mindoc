            ...
            <div class="navbar-header pull-right manual-menu">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right" role="menu" aria-labelledby="dLabel">
                        <li><a href="javascript:" data-toggle="modal" data-target="#shareProject">书籍分享</a> </li>
                        <li role="presentation" class="divider"></li>
                        <li><a href="https://wiki.iminho.me/export/1" target="_blank">书籍导出</a> </li>
                ...
                <div class="article-content">
                    <div class="article-body editor-content"  id="page-content">
                        ...
                        <p>SmartWiki是一款针对IT团队开发的简单好用的文档管理系统。
                            可以用来储存日常接口文档，数据库字典，手册说明等文档。内置书籍管理，用户管理，权限管理等功能，能够满足大部分中小团队的文档管理需求。</p>
                        ...
                        <p><strong>我的书籍</strong></p>
                        <p><img src="https://raw.githubusercontent.com/lifei6671/SmartWiki/master/storage/app/images/20161124082647.png" alt="我的书籍" /></p>
                        <p><strong>书籍参与用户</strong></p>
                        <p><img src="https://raw.githubusercontent.com/lifei6671/SmartWiki/master/storage/app/images/20161124082703.png" alt="书籍参与用户" /></p>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="https://wiki.iminho.me/show/1" class="form-control" onmouseover="this.select()" id="projectUrl" title="书籍地址">
                    </div>
