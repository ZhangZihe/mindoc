...
<head>
    ...
    <title>文档库管理 - Powered by MinDoc</title>
    ...
    <div class="container manual-body">
        ...
        {{template "manager/widgets.tpl" "itemsets"}}
            <div class="page-right">
                <div class="m-box">
                    <div class="box-head">
                        <strong class="box-title">文档库管理</strong>
                    {{if eq .Member.Role 0}}
                        <button type="button" class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#addItemsetsDialogModal"><i class="fa fa-plus" aria-hidden="true"></i> 创建文档库</button>
                    {{end}}
                    </div>
                </div>
                <div class="box-body">
                    <div class="attach-list" id="ItemsetsList">
                        <table class="table">
                            ...
                            <tr>
                                <th width="10%">#</th>
                                <th width="30%">文档库名称</th>
                                <th width="20%">文档库标识</th>
                                <th width="20%">书籍数量</th>
                                <th>操作</th>
                            </tr>
                            </thead>
        ...
        <form method="post" autocomplete="off" class="form-horizontal" action="{{urlfor "ManagerController.ItemsetsEdit"}}" id="addItemsetsDialogForm">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">创建文档库</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="account">文档库名称<span class="error-message">*</span></label>
                        <div class="col-sm-9">
                            <input type="text" name="itemName" class="form-control" placeholder="文档库名称" id="itemName" maxlength="50">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="itemKey">文档库标识<span class="error-message">*</span></label>
                        <div class="col-sm-9">
                            <input type="text" name="itemKey" id="itemKey" class="form-control" placeholder="文档库标识" maxlength="50">
                            <p class="text">文档库标识只能由字母和数字组成且在2-100字符之间</p>
                        </div>
                    </div>
    ...
    <div class="modal-dialog" role="document">
        <form method="post" autocomplete="off" class="form-horizontal" action="{{urlfor "ManagerController.ItemsetsEdit"}}" id="editItemsetsDialogForm">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="myModalLabel">编辑文档库</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="itemName">文档库名称<span class="error-message">*</span></label>
                        <div class="col-sm-9">
                            <input type="text" name="itemName" id="itemName" class="form-control" placeholder="文档库名称" maxlength="50">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="itemKey">文档库标识<span class="error-message">*</span></label>
    ...
    $(function () {
        ...
        addItemsetsDialogForm.ajaxForm({
            beforeSubmit: function () {
                ...
                if ($itemName == "") {
                    showError("文档库名称不能为空","#create-form-error-message");
                }
                if ($itemKey == "") {
                    showError("文档库标识不能为空","#create-form-error-message");
                }
        ...
        editItemsetsDialogForm.ajaxForm({
           beforeSubmit: function () {
               ...
               if ($itemName == "") {
                   showError("文档库名称不能为空","#edit-form-error-message");
               }
               if ($itemKey == "") {
                   showError("文档库标识不能为空","#edit-form-error-message");
               }
