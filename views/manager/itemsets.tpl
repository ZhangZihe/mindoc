...
<head>
    ...
    <title>书架管理 - Powered by MinDoc</title>
    ...
    <div class="container manual-body">
        ...
        {{template "manager/widgets.tpl" "itemsets"}}
            <div class="page-right">
                <div class="m-box">
                    <div class="box-head">
                        <strong class="box-title">书架管理</strong>
                    {{if eq .Member.Role 0}}
                        <button type="button" class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#addItemsetsDialogModal"><i class="fa fa-plus" aria-hidden="true"></i> 创建书架</button>
                    {{end}}
                    </div>
                </div>
                <div class="box-body">
        ...
        <form method="post" autocomplete="off" class="form-horizontal" action="{{urlfor "ManagerController.ItemsetsEdit"}}" id="addItemsetsDialogForm">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">创建书架</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="account">书架名称<span class="error-message">*</span></label>
                        <div class="col-sm-9">
                            <input type="text" name="itemName" class="form-control" placeholder="书架名称" id="itemName" maxlength="50">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="itemKey">书架标识<span class="error-message">*</span></label>
                        <div class="col-sm-9">
                            <input type="text" name="itemKey" id="itemKey" class="form-control" placeholder="书架标识" maxlength="50">
                            <p class="text">书架标识只能由字母和数字组成且在2-100字符之间</p>
                        </div>
                    </div>
    ...
    <div class="modal-dialog" role="document">
        <form method="post" autocomplete="off" class="form-horizontal" action="{{urlfor "ManagerController.ItemsetsEdit"}}" id="editItemsetsDialogForm">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="myModalLabel">编辑书架</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="itemName">书架名称<span class="error-message">*</span></label>
                        <div class="col-sm-9">
                            <input type="text" name="itemName" id="itemName" class="form-control" placeholder="书架名称" maxlength="50">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="itemKey">书架标识<span class="error-message">*</span></label>
    ...
    $(function () {
        ...
        addItemsetsDialogForm.ajaxForm({
            beforeSubmit: function () {
                ...
                if ($itemName == "") {
                    showError("书架名称不能为空","#create-form-error-message");
                }
                if ($itemKey == "") {
                    showError("书架标识不能为空","#create-form-error-message");
                }
        ...
        editItemsetsDialogForm.ajaxForm({
           beforeSubmit: function () {
               ...
               if ($itemName == "") {
                   showError("书架名称不能为空","#edit-form-error-message");
               }
               if ($itemKey == "") {
                   showError("书架标识不能为空","#edit-form-error-message");
               }
